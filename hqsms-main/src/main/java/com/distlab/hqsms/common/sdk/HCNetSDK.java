...
public interface HCNetSDK extends Library {
  ...
  public static final int KEY_PTZ_UP_STOP = 32;
...
//网络(NET_DVR_NETCFG_V30结构)
  ...
  public static final int NET_DVR_STREAM_INFO = 3251; // 获取GBT28181协议接入设备的通道信息
  public static final int NET_DVR_GET_GBT28181_ACCESS_CFG = 3249; // 获取GBT28181协议接入配置
  /***************************DS9000新增命令(_V30) end *****************************/
  /*************************参数配置命令 end*******************************/
  /*******************查找文件和日志函数返回值*************************/
  ...
  public static final int COMM_RULE_INFO_UPLOAD = 0x1107;   //  事件数据信息
  public static final int COMM_ALARM_FACE = 0x1106;   //  人脸检测识别报警信息
  public static final int COMM_UPLOAD_FACESNAP_RESULT = 0x1112;   //  人脸抓拍结果信息
  public static final int COMM_FACECAPTURE_STATISTICS_RESULT = 0x112a;   //  人脸抓拍人员统计信息
  public static final int COMM_SNAP_MATCH_ALARM = 0x2902;   //  人脸黑名单比对结果信息
  public static final int COMM_ALARM_FACE_DETECTION = 0x4010;   //  人脸侦测报警信息
  public static final int COMM_ALARM_TARGET_LEFT_REGION = 0x4011;   //  教师离开讲台报警
  public static final int COMM_PEOPLE_DETECTION_UPLOAD = 0x4014;   //  人员侦测信息
  ...
  public static final int COMM_SIGN_ABNORMAL_ALARM = 0x6120;   //  体征异常报警(Json数据结构)
  public static final int COMM_HFPD_ALARM = 0x6121;   //  高频人员检测报警(Json数据结构)
  public static final int COMM_ALARM_VQD_EX = 0x1116;   //  VQD报警信息
  public static final int COMM_ALARM_VQD = 0x6000;   //  VQD诊断报警信息
  public static final int COMM_SCENECHANGE_DETECTION_UPLOAD = 0x1130;   //  场景变更报警信息
  public static final int COMM_CROSSLINE_ALARM = 0x1131;   //  压线报警信息
  public static final int COMM_ALARM_AUDIOEXCEPTION = 0x1150;   //  声音报警信息
  public static final int COMM_ALARM_DEFOCUS = 0x1151;   //  虚焦报警信息
  public static final int COMM_SWITCH_LAMP_ALARM = 0x6002;   //  开关灯检测报警信息
  public static final int COMM_UPLOAD_HEATMAP_RESULT = 0x4008;   //  热度图报警信息
  public static final int COMM_FIREDETECTION_ALARM = 0x4991;   //  火点检测报警信息
  public static final int COMM_FACE_THERMOMETRY_ALARM = 0x4994;   //  人脸测温报警信息
  public static final int COMM_THERMOMETRY_DIFF_ALARM = 0x5211;   //  温差报警信息
  public static final int COMM_THERMOMETRY_ALARM = 0x5212;   //  温度报警信息
  public static final int COMM_ALARM_SHIPSDETECTION = 0x4521;   //  船只检测报警信息
  // 智能交通
  public static final int COMM_ALARM_AID = 0x1110;   //  交通事件报警信息
  public static final int COMM_ALARM_TPS = 0x1111;   //  交通参数统计报警信息
  public static final int COMM_ALARM_TFS = 0x1113;   //  交通取证报警信息
  public static final int COMM_ALARM_TPS_V41 = 0x1114;   //  交通参数统计报警信息(扩展)
  ...
  public static final int COMM_ITS_TRAFFIC_COLLECT = 0x3051;   //  交通统计数据上传
  public static final int COMM_ITS_BLACKLIST_ALARM = 0x3057;   //  车辆黑名单报警上传
  public static final int COMM_VEHICLE_CONTROL_LIST_DSALARM = 0x3058;   //  车辆黑白名单数据需要同步报警上传
  public static final int COMM_VEHICLE_CONTROL_ALARM = 0x3059;   //  黑白名单车辆报警上传
  public static final int COMM_FIRE_ALARM = 0x3060;   //  消防报警上传
  public static final int COMM_VEHICLE_RECOG_RESULT = 0x3062;   //  车辆二次识别结果上传
  public static final int COMM_ALARM_SENSORINFO_UPLOAD = 0x3077;   //  传感器上传信息
  public static final int COMM_ALARM_CAPTURE_UPLOAD = 0x3078;   //  抓拍图片上传
  public static final int COMM_ITS_RADARINFO = 0x3079;   //  雷达报警上传
  public static final int COMM_SIGNAL_LAMP_ABNORMAL = 0x3080;   //  信号灯异常检测上传
  ...
  public static final int COMM_ITS_ROAD_EXCEPTION = 0x4500;   //  路口设备异常报警信息
  public static final int COMM_ITS_EXTERNAL_CONTROL_ALARM = 0x4520;   //  指示灯外控报警信息
  public static final int COMM_ITS_GATE_FACE = 0x3053;   //  出入口人脸抓拍数据
  public static final int COMM_ITS_GATE_ALARMINFO = 0x3061;   //  出入口控制机数据
  public static final int COMM_GATE_CHARGEINFO_UPLOAD = 0x3064;   //  出入口付费信息
  public static final int COMM_TME_VEHICLE_INDENTIFICATION = 0x3065;   //  出入口控制器TME车辆抓拍信息
  public static final int COMM_GATE_CARDINFO_UPLOAD = 0x3066;   //  出入口卡片信息
  // 报警主机
  public static final int COMM_ALARM_ALARMHOST = 0x1105;   //  网络报警主机报警信息
  public static final int COMM_SENSOR_VALUE_UPLOAD = 0x1120;   //  模拟量数据实时信息
  public static final int COMM_SENSOR_ALARM = 0x1121;   //  模拟量报警信息
  public static final int COMM_SWITCH_ALARM = 0x1122;   //  网络报警主机报警信息
  public static final int COMM_ALARMHOST_EXCEPTION = 0x1123;   //  模拟量数据实时信息
  public static final int COMM_ALARMHOST_SAFETYCABINSTATE = 0x1125;   //  防护舱状态信息
  public static final int COMM_ALARMHOST_ALARMOUTSTATUS = 0x1126;   //  报警输出口或警号状态信息
  public static final int COMM_ALARMHOST_CID_ALARM = 0x1127;   //  报警主机CID报告报警上传
  public static final int COMM_ALARMHOST_EXTERNAL_DEVICE_ALARM = 0x1128;   //  报警主机外接设备报警信息
  public static final int COMM_ALARMHOST_DATA_UPLOAD = 0x1129;   //  报警数据信息
  public static final int COMM_ALARM_WIRELESS_INFO = 0x122b;   //  无线网络信息上传
  // 其他设备报警
  public static final int COMM_ALARM = 0x1100;   //  移动侦测、视频丢失、遮挡、IO信号量等报警信息(V3.0以下版本支持的设备)
  public static final int COMM_ALARM_V30 = 0x4000;   //  移动侦测、视频丢失、遮挡、IO信号量等报警信息(V3.0以上版本支持的设备)
  public static final int COMM_ALARM_V40 = 0x4007;   //  移动侦测、视频丢失、遮挡、IO信号量等报警信息，报警数据为可变长
  public static final int COMM_IPCCFG = 0x4001;   //  混合型DVR、NVR等在IPC接入配置改变时的报警信息
  public static final int COMM_IPCCFG_V31 = 0x4002;   //  混合型DVR、NVR等在IPC接入配置改变时的报警信息（扩展）
  public static final int COMM_IPC_AUXALARM_RESULT = 0x2820;   //  PIR报警、无线报警、呼救报警信息
  public static final int COMM_ALARM_DEVICE = 0x4004;   //  CVR设备报警信息，由于通道值大于256而扩展
  public static final int COMM_ALARM_DEVICE_V40 = 0x4009;   //  CVR设备报警信息扩展(增加报警信息子结构)
  public static final int COMM_ALARM_CVR = 0x4005;   //  CVR外部报警信息
  public static final int COMM_TRADEINFO = 0x1500;   //  ATM DVR交易信息
  public static final int COMM_ALARM_HOT_SPARE = 0x4006;   //  热备异常报警（N+1模式异常报警）信息
  public static final int COMM_ALARM_BUTTON_DOWN_EXCEPTION = 0x1152;   //  按钮按下报警信息(IP可视对讲主机)
  ...
  public static final int COMM_SCREEN_ALARM = 0x5000;   //  多屏控制器上传的报警信息
  public static final int COMM_ALARM_LCD = 0x5011;   //  LCD屏幕报警信息
  public static final int COMM_UPLOAD_VIDEO_INTERCOM_EVENT = 0x1132;   //  可视对讲事件记录信息
  public static final int COMM_ALARM_VIDEO_INTERCOM = 0x1133;   //  可视对讲报警信息
  public static final int COMM_ALARM_DEC_VCA = 0x5010;   //  解码器智能解码报警信息
  public static final int COMM_GISINFO_UPLOAD = 0x4012;   //  GIS信息
  public static final int COMM_VANDALPROOF_ALARM = 0x4013;   //  防破坏报警信息
  public static final int COMM_ALARM_STORAGE_DETECTION = 0x4015;   //  存储智能检测报警信息
  public static final int COMM_CONFERENCE_CALL_ALARM = 0x5012;   //  会议终端会议呼叫报警信息
  public static final int COMM_ALARM_ALARMGPS = 0x1202;   //  GPS报警信息
  public static final int COMM_ALARM_SWITCH_CONVERT = 0x5004;   //  交换机报警信息
  public static final int COMM_INQUEST_ALARM = 0x6005;   //  审讯主机报警信息
  public static final int COMM_PANORAMIC_LINKAGE_ALARM = 0x5213;   //  鹰眼全景联动到位事件信息
  public static final int COMM_TAG_INFO_ALARM = 0x5215;   //  标签信息上传
  public static final int COMM_CLUSTER_ALARM = 0x6020;   //  集群报警信息（集群异动（扩容\缩容等）时布防CS失败异常，收到此异常，需要重新布防集群设备，否则会有CS的报警丢失。普通设备不会回调该异常，只针对集群）
...
//智能设备类型
  ...
  public static final int PTZ_COMMAND_LIGHT_PWRON = 2; //接通灯光电源
  public static final int PTZ_COMMAND_WIPER_PWRON = 3; //接通雨刷开关
  public static final int PTZ_COMMAND_FAN_PWRON = 4; //接通风扇开关
  public static final int PTZ_COMMAND_HEATER_PWRON = 5; //接通加热器开关
  public static final int PTZ_COMMAND_AUX_PWRON1 = 6; //接通辅助设备开关
  public static final int PTZ_COMMAND_AUX_PWRON2 = 7; //接通辅助设备开关
  public static final int PTZ_COMMAND_ZOOM_IN = 11; //焦距变大(倍率变大)
  public static final int PTZ_COMMAND_ZOOM_OUT = 12; //焦距变小(倍率变小)
  public static final int PTZ_COMMAND_FOCUS_NEAR = 13; //焦点前调
  public static final int PTZ_COMMAND_FOCUS_FAR = 14; //焦点后调
  public static final int PTZ_COMMAND_IRIS_OPEN = 15; //光圈扩大
  public static final int PTZ_COMMAND_IRIS_CLOSE = 16; //光圈缩小
  public static final int PTZ_COMMAND_TILT_UP = 21; //云台上仰
  public static final int PTZ_COMMAND_TILT_DOWN = 22; //云台下俯
  public static final int PTZ_COMMAND_PAN_LEFT = 23; //云台左转
  public static final int PTZ_COMMAND_PAN_RIGHT = 24; //云台右转
  public static final int PTZ_COMMAND_UP_LEFT = 25; //云台上仰和左转
  public static final int PTZ_COMMAND_UP_RIGHT = 26; //云台上仰和右转
  public static final int PTZ_COMMAND_DOWN_LEFT = 27; //云台下俯和左转
  public static final int PTZ_COMMAND_DOWN_RIGHT = 28; //云台下俯和右转
  public static final int PTZ_COMMAND_PAN_AUTO = 29; //云台左右自动扫描
  public static final int PTZ_COMMAND_TILT_DOWN_ZOOM_IN = 58; //云台下俯和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_TILT_DOWN_ZOOM_OUT = 59; //云台下俯和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_PAN_LEFT_ZOOM_IN = 60; //云台左转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_PAN_LEFT_ZOOM_OUT = 61; //云台左转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_PAN_RIGHT_ZOOM_IN = 62; //云台右转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_PAN_RIGHT_ZOOM_OUT = 63; //云台右转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_UP_LEFT_ZOOM_IN = 64; //云台上仰和左转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_UP_LEFT_ZOOM_OUT = 65; //云台上仰和左转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_UP_RIGHT_ZOOM_IN = 66; //云台上仰和右转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_UP_RIGHT_ZOOM_OUT = 67; //云台上仰和右转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_DOWN_LEFT_ZOOM_IN = 68; //云台下俯和左转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_DOWN_LEFT_ZOOM_OUT = 69; //云台下俯和左转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_DOWN_RIGHT_ZOOM_IN = 70; //云台下俯和右转和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_DOWN_RIGHT_ZOOM_OUT = 71; //云台下俯和右转和焦距变小(倍率变小)
  public static final int PTZ_COMMAND_TILT_UP_ZOOM_IN = 72; //云台上仰和焦距变大(倍率变大)
  public static final int PTZ_COMMAND_TILT_UP_ZOOM_OUT = 73;  //云台上仰和焦距变小(倍率变小)
  ...
  public static final int MAX_SERVERID_LEN = 64; //最大服务器ID的长度
  public static final int MAX_SERVERDOMAIN_LEN = 128; //服务器域名最大长度
  public static final int MAX_AUTHENTICATEID_LEN = 64; //认证ID最大长度
  public static final int MAX_AUTHENTICATEPASSWD_LEN = 32; //认证密码最大长度
  public static final int MAX_SERVERNAME_LEN = 64; //最大服务器用户名
  public static final int MAX_COMPRESSIONID_LEN = 64; //编码ID的最大长度
  public static final int MAX_SIPSERVER_ADDRESS_LEN = 128; //SIP服务器地址支持域名和IP地址
  ...
  int NET_DVR_FindFile_V40(int lUserID, NET_DVR_FILECOND pFindCond);

  int NET_DVR_FindFileByEvent_V40(int lUserID, NET_DVR_SEARCH_EVENT_RET_V40 pSearchEventRet);
...
/****************************ATM(end)***************************/
  ...
  int NET_DVR_SetupAlarmChan_V50(int lUserID, NET_DVR_SETUPALARM_PARAM lpSetupParam, Pointer pData, int dwDataLen);
...
//NET_DVR_Login()参数结构
  ...
  //预览V40接口，此定义在Linux下无法拉流
  public static class NET_DVR_PREVIEWINFO_V40 extends Structure {
  ...
  public static class NET_DVR_SEARCH_EVENT_RET_V40 extends Structure {
    public int dwMajorType;//搜索主类型
    public int dwMinorType;//搜索次类型
    public NET_DVR_TIME struStartTime;//开始时间
    public NET_DVR_TIME struStopTime;//结束时间
    public byte byLockType;//是否锁定：0xff- 全部，0- 未锁，1- 锁定
    public byte byQuickSearch; //0:普通查询，1：快速（日历）查询
...
//截止2004年10月5日,共116个接口
  ...
  public static class NET_DVR_GBT28181_CHANINFO_CFG extends Structure {
    public int dwSize;
    public byte[] szAlarmInNumID = new byte[65];
    public byte[] byRes = new byte[256];
  ...
  public static class NET_DVR_GBT28181_ACCESS_CFG extends Structure {
    ...
    public byte[] szServerID = new byte[MAX_SERVERID_LEN];
    public byte[] szServerDomain = new byte[MAX_SERVERDOMAIN_LEN];
    public byte[] szSipServerAddress = new byte[MAX_SIPSERVER_ADDRESS_LEN];
    public short wServerSipPort;
    public byte byProtocolVersion;
    public byte byRes3;
    public byte[] szSipUserName = new byte[MAX_SERVERNAME_LEN];
    public byte[] szSipAuthenticateID = new byte[MAX_AUTHENTICATEID_LEN];
    public byte[] szSipAuthenticatePasswd = new byte[MAX_AUTHENTICATEPASSWD_LEN];
    ...
    public byte[] szDeviceDomain = new byte[MAX_SERVERDOMAIN_LEN];
