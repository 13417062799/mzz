...
//
//  public static final String strTip = Res.string().getTips();
//
//  public static final int ZERO = 0;
//  public static final int ONE = 1;
//
//  public static final long beginNum = 0;
//
//  public static final int faillUserID = -1;
//
//  public static final int initNum = -1;
//  public static final String initIp = "0.0.0.0";
//
//  public static final String initPort = "0000";
//
//  public static final int min_s = 1000;
//
//  public static final String UNIXTIME = "1970-01-01 00:00:00";
//
//  public static final int FaceCaptureTarget = 1;
//
//  public static final int FaceRecognitionTarget = 2;
//
//  public static final String strDot = ".";
//  public static final int stopRealplay = 0; //重置关闭接口返回值 Reset the return value of the close interface
//  public static final String pathStart = "C:\\HW_SDK_LOG\\";
//  public static final String pathIP = "IP";
//  public static final String extensionFormatFile = ".jpg";
//
//  public static final String pathFaceCapture = Res.string().getFaceCheck() + "\\";
//  public static final int PU_EVENT_TYPE_MAX = 22; //Reserved value
//  public static final String pathFaceRecognition = Res.string().getFaceRecogin() + "\\";
//  public static final String faceLibInfoPath = "C:\\HW_SDK_LOG\\neo.json";
//  public static final String faceInfoPath = "C:\\HW_SDK_LOG\\ne.json";
//  public static final String facePanorama = "FACE_PANORAMA_";
//
//  public static final String facePic = "FACE_PIC_";
//
//  public static final String faceMatch = "FACE_MATCH_";
...
//
//  public static final String man = Res.string().getGenderTypeMan();
//
//  public static final String women = Res.string().getGenderTypeWoman();
//
//  public static final String unknow = Res.string().getGenderTypeNothing();
//
//  public static final String iDENTITY = Res.string().getCardTypeIdentity();
//
//  public static final String pASSPORT = Res.string().getCardTypePassport();
//
//  public static final String oFFICER = Res.string().getCardTypeOfficeport();
//
//  public static final String dRIVING = Res.string().getCardTypeDriverport();
//
//  public static final String oTHERS = Res.string().getCardTypeOther();
  public static final int PU_EVENT_TYPE_MAX = 22; //Reserved value
  /********************************Macro Definition**********************************************/
  public static final int linkModulePUAutologinMode = 0; //Active login mode, initialized after the front-end device actively log on to the SDK, only decoder support
  public static final int linkModulePUMaualLoginMode = 1;//manual login mode, need to manually call the IVS-PU-Login login front-end device
  public static final int linkModulePUBothLoginMode = 3;
...
/************************** Macro Definition Ends   ***************************/
  ...
  //logout from device
  boolean IVS_PU_Logout(long ulIdentifyID);
  ...
  boolean IVS_PU_DiscoveryDeviceByIpAddresses(String pszStartIpAddr, String pszEndIpAddr, NativeLong ulSearchNum, PU_DISCOVER_DEVICE_INFO pszDeviceList, NativeLong pulDeviceNum);
  ...
  //real play
  public int IVS_PU_RealPlay(ULONG ulIdentifyID, PU_REAL_PLAY_INFO_S pstRealPlayInfo,
  ...
  public boolean IVS_PU_StopRealPlay(ULONG ulIdentifyID, int ulRealPlayHnd);
  ...
  public interface PU_STREAM_TYPE {
  ...
  //Transmission type.
  public interface PU_PROTOCOL_TYPE {
  ...
  //Media callback type.
  public interface PU_MEDIA_CALLBACK_TYPE {
  ...
  public interface PU_VIDEO_TYPE {
  ...
  public interface PU_SNAPSHOT_TYPE {
    ...
    public static final int PU_SNAPSHOT_TYPE_ITGT = 5;                       //Intelligent analysis?Ctriggered snapshot.
    public static final int PU_SNAPSHOT_TYPE_ITS = 6;                       //ITS snapshot.
    public static final int PU_SNAPSHOT_TYPE_VEHICLE = 7;                   //Vehicle event?Ctriggered snapshot.
...
// TRAFFIC_DOME_ILLEGAL_PARKINK_PARAMS_S
  ...
  public interface LAYER_THREE_TYPE {
    ...
    public static final int RIDERMAN_FEATURE = 0x13000001;//??????????
...
//Snapshot type.
  ...
  public static class PU_DISCOVER_DEVICE_INFO extends Structure {
  ...
  public static class PU_DISCOVER_DEVICE_LIST extends Structure {
    NativeLong ulDeviceNum;
    PU_DISCOVER_DEVICE_INFO[] stDeviceInfo = new PU_DISCOVER_DEVICE_INFO[PU_DEVICE_NUM_MAX];
  ...
  public static class PU_DEVICE_ETHERNET_PARA extends Structure {
    WinDef.BOOL bDhcpEnable;                          //Indicates whether to enable DHCP.
    byte[] szIPAddress = new byte[PU_IP4_ADDR_LEN];         //IP address.
    byte[] szSubNetMask = new byte[PU_IP4_ADDR_LEN];        //Subnet mask.
    byte[] szGateWayAddress = new byte[PU_IP4_ADDR_LEN];    //Gateway IP address.
    byte[] szFirstDNSAddress = new byte[PU_IP4_ADDR_LEN];   //First group of DNS addresses.
    byte[] szSecondDNSAddress = new byte[PU_IP4_ADDR_LEN];  //Second group of DNS addresses.
    byte[] szReserved = new byte[PU_RESERVE_LEN];           //szReserved[0]: network port index. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2.
  ...
  public static class PU_SNMPV3_USER_MGMT extends Structure {
    int enManipulateType;                      //Operation type.  c type : PU_OPT_TYPE_E
    PU_SNMPV3_USER_INFO stMgmtUserInfo;                //Operation information.
    byte[] szModifyVerifyPwd = new byte[PU_PASSWORD_LEN];             //Authentication password of the current SNMP user (the security level is not noauth).
    byte[] szReserved = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_IGT_POINT_S extends Structure {
    WinDef.USHORT usPointPosX;                     /*X coordinate of the point (0-352).*/
    WinDef.USHORT usPointPosY;                     /*Y coordinate of the point (0-288).*/
  ...
  public static class PU_IPFILTER_RULES_INFO extends Structure {
    WinDef.BOOL bIpFilterEnable;                                           //Indicates whether to enable IP address filtering.
    int enIpFilterStrategy;                     //IP address filtering policy: whitelist or blacklist. c type:PU_IP_FILTER_STRATEGY
    NativeLong ulIpFilterRulesNum;                                       //IP address filtering rule item.
    PU_IPFILTER_RULES[] stIpFilterRulesList = new PU_IPFILTER_RULES[PU_IP_FILTER_NUM_MAX];  //IP address filtering rule list.
    byte[] szReserve = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_IPFILTER_RULESV2 extends Structure {
    int enMatchType;                      //???? C type:PU_IPFILTER_MATCH_TYPE
    byte[] szIPAddress = new byte[PU_IP4_ADDR_LEN];                         //IP address by which data packets are to be filtered out.
    byte[] szSubNetAddress = new byte[PU_IP4_ADDR_LEN];                     //Subnet mask by which data packets are to be filtered out.
    NativeLong ulIpBeginPort;                                       //Start port by which data packets are to be filtered out.
    NativeLong ulIpEndPort;                                         //End port by which data packets are to be filtered out.
    int enProtocolType;                      //Protocol by which data packets are to be filtered out.
    byte[] szMACAddress = new byte[PU_HEX_MAC_ADDR_LEN + 1];                    //MAC address by which data packets are to be filtered out.
    WinDef.BOOL bStatus;                                              //Data packet filtering rule status, effective or not effective.
    byte[] szReserve = new byte[PU_RESERVE_LEN];                            //szReserve[0] indicates the applied network adapter. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2. The rest can be deducted by analogy.
  ...
  public static class PU_USER_LIST extends Structure {
    ULONG ulCurrentUserNum;                               //Number of current users.
    PU_USER_INFO[] szUserList = new PU_USER_INFO[PU_DEVICE_USER_NUM_MAX];    //Current user list.
    byte[] szReserved = new byte[PU_RESERVE_LEN];
    public PU_USER_LIST() {
      this.setAlignType(ALIGN_NONE);
    }
  ...
  public static class PU_AUTO_ARP_BROADCAST_PARA extends Structure {
    ...
    public ULONG ulCycleDay;                       //Period, 1?C120 days.
    public byte[] szReserved = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_CAM_EXPCOMP_PARA extends Structure {
    ...
    public NativeLong lExpComp;                           //Compensation coefficient (0?C255).
    public byte[] szReserve = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_CAM_WD_PARA extends Structure {
    ...
    public NativeLong lExpRatio;                              //Sony: x1?Cx64; Hitachi: 127
    public ULONG ulAutoModeMaxExpRatio;                 //Maximum exposure ratio in auto WDR mode. T1: 1?C16. The default value is 8.
    public byte[] szReserve = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_BACKLIGHT_MODE extends Structure {
    ...
    public NativeLong lBackLight;                            //Compensation level: 0?C255.
  ...
  public static class PU_IMG_DRC extends Structure {
    ...
    public ULONG ulDRCStrength;            //HiSilicon: 0?C255; TI: 0?C255.
    public byte[] szReserve = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_TIME_QUANTUM_INFO extends Structure {
    public ULONG ulTimeQuantumId;                                //Time segment indexes 1?C8.
  ...
  public static class PU_VLPR_PARA_V3_S extends Structure {
    ...
    public long ulROIMeterLevel;                                               //License plate exposure coefficient.
...
//BOOL enEnableBodyAttri; // Indicates whether to enable personal attribute recognition.
  ...
  //PTZ location information: total zoom ratio (1?C30 x 12 = 240).
  public class PU_PTZ_CURRENT_LOCATION extends Structure {
    public NativeLong lPTZHorDegree;                    //Horizontal angle (0?? to 359??).
    public NativeLong lPTZVerDegree;                    //Vertical angle (?C10?? to +90??).
    public int ulLenMultiple;                    //Integral part of the lens zoom ratio (1?C30. If the digital zoom is not 0, the lens zoom ratio is the maximum value 30 by default.).
    public int ulDotLenMultiple;                 //Decimal part of the lens zoom ratio (0?C99; accurate only to one decimal place).
    public int ulZoomRatio;                      //Integral part of the digital zoom (0?C12. The parameter is set when the lens zoom ratio reaches the maximum value. The value 0 indicates that this parameter is not set. The total zoom ratio is the multiplication of zoom ratios.)
    public int ulDotZoomRatio;                   //Decimal part of the digital zoom (0?C99; accurate only to one decimal place).
    public int lPTZDotHorDegree;                        //Decimal part of the horizontal angle (0?C99; accurate only to one decimal place).
    public NativeLong lPTZDotVerDegree;                 //Decimal part of the vertical angle (?C99 to +99; accurate only to one decimal place).
    public byte[] szReserved = new byte[PU_RESERVE_LEN];
...
//        }
  ...
  public static class PU_ITS_DEV_INFO_S extends Structure {
    // enDeviceProtelType ???PU_EXTRA_DEVICE_TYPE_E
    public int enDeviceProtelType;                     //Protocol type of the external device.
...
//Local SIM card number.
  ...
  public static class PU_FACE_LIB_SET_S extends Structure {
    public WinDef.ULONG ulChannelId = new ULONG(101); // 101
  ...
  public static class PU_ITS_ILLEGAI_DIC_PARA_UNIT_S extends Structure {
    public byte[] szIllTypeString = new byte[PU_ITS_ILLEGAL_TYPE_LEN_MAX];       //Violation type, which cannot be modified. The maximum length is as follows: PU_ITS_ILLEGAL_TYPE_LEN_MAX ?C 4.
    public byte[] szIllCodeString = new byte[PU_ITS_ILLEGAL_NUM_LEN_MAX];        //Violation code. The maximum length is as follows: PU_ITS_ILLEGAL_NUM_LEN_MAX ?C 1.
    public byte[] szIllNameString = new byte[PU_ITS_ILLEGAL_NAME_LEN_MAX];       //Superimposed violation name. The maximum length is as follows: PU_ITS_ILLEGAL_NAME_LEN_MAX ?C 4.
  ...
  public static class PU_EVENT_COMMON extends Structure {
    public int enEventType;            //??????? PU_EVENT_TYPE
    public ULONG ulIdentifyID;           //Ψ??????ID??
    public ULONG ulChannelId;
  ...
  public static class tagItsEPoliceSnapType_V2 extends Structure {
    public WinDef.ULONG ulChannelId;     //Channel ID.
    public int enITSType;       // ITS???????    EN_ITS_TYPE
    public int enRegulaDtType;  // Υ?????????   EN_ITS_REGULA_DT_TYPE
    public int[] aiMultiSnapInterval = new int[ITS_SNAP_NUM_MAX];  //Continuous snapshot interval, in milliseconds.
    /* ePolice:1: checkpoint; 3: speeding; 4: low-speed; 6: wrong-way driving; 7: end-number policy violation; 8: marked lanes violation; 9: unsafe lane change; 10: motor vehicles on non-motor vehicle lanes
     *         21: parking in yellow zones; 22: failure to give right-of-way to pedestrians; 23: bus lane violation; 24: driving large vehicles on prohibited lanes;
     *
...
//                    uniAttach.setType(uniAttach.stImpolitePedestriansTime.getClass());
  ...
  public static class PU_ITS_MANUAL_SNAPSHOT_PARA extends Structure {
    public ULONG ulSnapNum;    //???????,????MAX_BURST_SHOOTING_NUM  (??????1,?????????)
    public ULONG[] aulSnapInterval = new ULONG[MAX_BURST_SHOOTING_NUM - 1];  //?????(ms) ????[MIN_ITS_SNAPSHOT_INTERVAL, MAX_ITS_SNAPSHOT_INTERVAL]
    public byte[] szReserved = new byte[PU_RESERVE_LEN];
  ...
  public static class PU_PTZ_CURRENT_LOCATION_EX extends Structure {
    public NativeLong lPTZHorDegree;               //Horizontal angle (0?? to 359??).
    public NativeLong lPTZVerDegree;               //Vertical angle (?C10?? to +90??).
    public ULONG ulLenMultiple;                    //Integral part of the lens zoom ratio (1?C30. If the digital zoom is not 0, the lens zoom ratio is the maximum value 30 by default.).
    public ULONG ulDotLenMultiple;                 //Decimal part of the lens zoom ratio (0?C99; accurate only to one decimal place).
    public ULONG ulZoomRatio;                      //Integral part of the digital zoom (0?C12. The parameter is set when the lens zoom ratio reaches the maximum value. The value 0 indicates that this parameter is not set. The total zoom ratio is the multiplication of zoom ratios.)
    public ULONG ulDotZoomRatio;                   //Decimal part of the digital zoom (0?C99; accurate only to one decimal place).
    public NativeLong lPTZDotHorDegree;            //Decimal part of the horizontal angle (0?C99; accurate only to one decimal place).
    public NativeLong lPTZDotVerDegree;            //Decimal part of the vertical angle (?C99 to +99; accurate only to one decimal place).
  ...
  public static class PU_TD_ALG_PARAMS extends Structure {
    ...
    public NativeLong lPTZCalibrationHorizontal;  //PTZ calibration parameter (horizontal). The value ranges from ?C2 to 2.
    public NativeLong lPTZCalibrationVertical;    //PTZ calibration parameter (vertical). The value ranges from ?C2 to 2.
  ...
  public static class PU_MASTER_SLAVE_TRACK_PARA extends Structure {
    ...
    public ULONG ulGroupID; //ID of the master/slave device association. This parameter is reserved and is not used currently.
    // enMode C???? PU_MASTER_SLAVE_TRACK_MODE_E
    public int enMode; //Tracking policy.
    // enObjectSize C???? PU_TRACK_OBJECT_SIZE_E
  ...
  public static class PU_ITS_RESTRICTED_PARAM extends Structure {
    ...
    public PU_ITS_RESTRICTED_PARA_UNIT[] astRestricteds = (PU_ITS_RESTRICTED_PARA_UNIT[]) new PU_ITS_RESTRICTED_PARA_UNIT().toArray(MAX_RESTRICTED_EVENT_NUM);     //β????????????
    public byte[] szReserved = new byte[PU_RESERVE_EX_LEN];
  ...
  public static class PU_META_DATA extends Structure {
    ...
    public WinDef.USHORT usValidNumber;
  ...
  public static class PU_UserData extends Structure {
    ...
    public void read() {
      ...
      switch (eType)       //Set the association type according to the value of eType.
      {
        ...
        case LAYER_THREE_TYPE.PANORAMA_PIC:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.HUMAN_FEATURE:
          unMetaData.setType(unMetaData.stHuamanAttr.getClass());
          unMetaData.read();
        case LAYER_THREE_TYPE.FACE_PIC:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.FACE_INFO:
          unMetaData.setType(unMetaData.stFaceInfo.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.FACE_FEATURE:
          unMetaData.setType(unMetaData.stFaceAttr.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.FACE_PANORAMA:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.FACE_MATCH:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
       /* case LAYER_THREE_TYPE.FACE_MATCHRATE:
            unMetaData.setType(unMetaData.uIntValue.getClass());
            unMetaData.read();*/

        case LAYER_THREE_TYPE.PLATE_PIC: {
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
        }
        break;
        case LAYER_THREE_TYPE.PLATE_CHAR:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.VEHICLE_PIC:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.CAR_YEAR_BRAND:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.CAR_SUB_BRAND:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
        case LAYER_THREE_TYPE.CAR_PRE_BRAND:
          unMetaData.setType(unMetaData.stBinay.getClass());
          unMetaData.read();
          break;
       /* case LAYER_THREE_TYPE.PLATE_TYPE:
            unMetaData.setType(unMetaData.uIntValue.getClass());
            unMetaData.read();
            break;
        case LAYER_THREE_TYPE.PLATE_COLOR:
            unMetaData.setType(unMetaData.uIntValue.getClass());
            unMetaData.read();
            break;
        case LAYER_THREE_TYPE.VEHICLE_TYPE:
            unMetaData.setType(unMetaData.uIntValue.getClass());
            unMetaData.read();
            break;
        case LAYER_THREE_TYPE.VEHICLE_COLOR:
            unMetaData.setType(unMetaData.uIntValue.getClass());
            unMetaData.read();
            break;*/
        default:
...
//          System.out.println("Unprocessed data types(eType): 0x" + (t.length() <= 7 ? "0" : "") + t);
  ...
  public static class unMetaData extends Union {
    ...
    public WinDef.ULONG uLonglongValue;
  ...
  public static class PU_IGT_ALARM_PARA extends Structure {
    ...
    public byte[] szReserved = new byte[PU_RESERVE_LEN];       //szReserved[0] ?????С??????(5~200??С???????)

    //szReserved[1] indicates the minimum object height (5?C200 pixels and smaller than the maximum height).
    //szReserved[2] indicates the maximum object width (5?C200 pixels).
    //szReserved[3] indicates the maximum object height (5?C200 pixels).
  ...
  public static class PU_TEMPERATURE_ALARM_PARA extends Structure {
    public NativeLong lEnable;                           //Indicates whether to enable the ROI.
    public ULONG ulDeteInterval;                   //Alarm check interval (1?C256s). The system checks the alarm status at a specified interval.
  ...
  public static class PU_DETECTION_AREA extends Structure {
    public ULONG ulNum;                                                    //?????θ???
    public PU_MASK_PARA[] stMaskPara = new PU_MASK_PARA[PU_ALARM_AREA_MAX];                   //???β???
  ...
  public static class PU_CUSTOM_OSD_PARA_S extends Structure {
    public byte[] acOSDContent = new byte[PU_OSD_MAX_LENGTH]; // OSD????
  ...
  public static class PU_PIC_SYNTHESIS_PARA_V3_S extends Structure {
    ...
    public ULONG ulPicSynthesisEnableMask[] = new ULONG[PU_ITS_PIC_SYNTHESIS_TYPE.ITS_TYPE_PIC_SYNTHESIS_MAX];  // ????[2~2^32)????λ???PU_ITS_REGULA_TYPE_E??Υ??????????????,??????(0)???????
  ...
  public static class PU_PTZ_FOCUS_MODE_S extends Structure {
    ...
    public ULONG ulFocusSensitivity;//?????????(??????????????Ч)????Χ0~2
    public byte[] szReserved = new byte[PU_RESERVE_EX_LEN];
