...
#define LOGIN_DOMAIN_LEN_MAX     (128 + 4)                                     // 登录域的最大长度
#define PU_PLATFORM_DEVICE_ID_LEN   24        // 设备id长度
#define PU_PLATFORM_DEVICE_ID_LEN64 65    
#define PU_ALARM_DIO_NUM_MAX  10
#define PU_AUDIO_DIO_NUM_MAX  10              //最大音频输入输出个数
#define PU_MULTI_CHANNEL_ID_NUM (6)  //多通道最大数量
...
#define PU_SLAVE_CLIENT_NAME_LEN	(72 + 4)	// 从设备用户名最大长度
#define PU_SLAVE_CLIENT_SN_LEN 	32		// 从设备用户SN最大长度
...
typedef enum ERROR_CODE {
    ...
    PU_ERROR_CODE_CONFIG_PASSWORD = 10035,           // 配置文件密码错误
    PU_RESULT_CHECK_ALL_ALG = 10036,                 // 算法创建失败，请先检查算法是否全部完成升级
	PU_RESULT_SERVER_INITCOMPLETE = 10037,			 // ITGT服务init初始化未完成
	...
	PU_ERROR_CODE_MODE_PARA_WITH_PIC = 10191,			// 切换自定义/国标模式的OSD参数与图片叠加冲突
	PU_ERROR_CODE_WEB_SDK_KEY_FILE = 10192,			// 秘钥文件正在传输
	PU_ERROR_CODE_ZOOM_IS_RESTIRCT = 10193,			//变倍聚焦功能受限，请进行镜头复位
    ...
    PU_ERROR_CODE_SMTP_USER_NAME_DIFFERENT_FROM_SENDER = 10604,  // SMTP配置，服务器认证中的用户名和发件人地址不一致
    PU_ERROR_CODE_STREAM_TYPE_FACE_ERROR = 10605,                  // 码流类型与智能人脸检测功能互斥
    PU_ERROR_CODE_CHILD_STREAM_RESOLUTION_FACE_ERROR = 10606,  // 子码流分辨率与智能人脸检测功能互斥
    ...
    PU_RESULT_TGT_FUNCTION_MUTUAL_VA,                   // 请先关闭智能告警功能
    ...
    PU_RESULT_TGT_FUNCTION_MUTUAL_BEH,                  // 请先关闭智能告警功能
	...
	PU_RESULT_TGT_FUNCTION_MUTUAL_TRAFFIC_FLOW_CAMPUS,       // 请先关闭视频车检器功能
	PU_RESULT_TGT_FUNCTION_MUTUAL_FIGHT,                     // 请先关闭复杂行为分析--打架
	PU_RESULT_TGT_FUNCTION_MUTUAL_CLIMB,                     // 请先关闭复杂行为分析--攀爬
	PU_RESULT_TGT_FUNCTION_MUTUAL_FALL_DOWN,                 // 请先关闭复杂行为分析--跌倒
	PU_RESULT_TGT_FUNCTION_MUTUAL_RUN,                       // 请先关闭复杂行为分析--奔跑
	PU_RESULT_TGT_FUNCTION_MUTUAL_FT,                        // 请先关闭人脸参数下的定时抓拍模式
	PU_RESULT_TGT_FUNCTION_MUTUAL_FIREDETECT,                // 请先关闭火点检测功能
	PU_RESULT_TGT_FUNCTION_MUTUAL_TEMPERATURE_CONTROL,       // 请先关闭温控功能
	PU_RESULT_TGT_FUNCTION_MUTUAL_VISIBLE_BEH,               // 请先关闭智能告警可见光通道业务
	PU_RESULT_TGT_FUNCTION_MUTUAL_THERMAL_BEH,               // 请先关闭智能告警热成像通道业务
    PU_RESULT_TGT_FUNCTION_MUTUAL_DISTORTION = 12041,                // 请先关闭畸变矫正
    PU_RESULT_TGT_FUNCTION_MUTUAL_INTELLIGENT_ENCODING,      // 请先关闭智能编码
    PU_RESULT_TGT_FUNCTION_MUTUAL_FACE_ATTRI,                // 请先关闭人脸属性
    PU_RESULT_TGT_FUNCTION_MUTUAL_CONTINUOUS_IMQ,            // 请先关闭连续图像调优诊断
    PU_RESULT_TGT_FUNCTION_MUTUAL_FL,                        // 请先关闭人脸参数下的低带宽抓拍模式
    PU_RESULT_TGT_FUNCTION_MUTUAL_VHDFACEMIX,                // 请首先关闭混行模式
    PU_RESULT_TGT_FUNCTION_MUTUAL_TRACK,                     // 请先关闭雷球联动功能
    PU_RESULT_TGT_FUNCTION_MUTUAL_YTN,                       // 请先关闭一拖N
	...
	PU_RESULT_ITGT_ERR_JSON_FILE_PARSE_FAIL,                // Json文件解析失败
	PU_RESULT_ITGT_ERR_FACE_PIC_EXTRACT_PROCESSING,         // 正在进行单张图片提取任务，NVR800
	PU_RESULT_ITGT_ERR_FACE_PIC_EXTRACT_TIMEOUT,            // 单张图片提取任务超时
    PU_RESULT_ITGT_ERR_FACE_LIB_CONTROL_OVERSIZE = 12144,   // 当前布控人脸库个数超出上限
    ...
    PU_RESULT_SMTP_PICNUM_ERR = 12454,			// 图片数量错误
    PU_RESULT_SMTP_SERVER_PORT_ERR = 12456,               // 服务器端口错误
    PU_RESULT_SMTP_SERVER_IP_ERR = 12460,                 // 服务器IP地址错误
    PU_RESULT_SMTP_REVPARA_ERR = 12463,           	// 收件人信息错误
    ...
    PU_RESULT_TGT_HUMANCOUNT_ERR_WRONG_MODE = 12540,      //人头计数与镜像模式、走廊模式互斥
	...
	PU_RESULT_PRASE_XML_FAIL,                      // 服务器解析XML失败

	// 一拖N 数据库错误码
	PU_RESULT_ITGT_ERR_DB_SUCCESS = 13500,
	PU_RESULT_ITGT_ERR_DB_NORECORD,
	PU_RESULT_ITGT_ERR_DB_UNKNOWN_TYPE,
	PU_RESULT_ITGT_ERR_1TN_DISABLE,                // 一拖N未使能
	PU_RESULT_ITGT_ERR_1TN_METADATA_BEYOND_LIMIT,  // 多机互助人脸识别信息展示项超出规格
	PU_RESULT_ITGT_ERR_1TN_DELETE_DATETIME_PERIOD_OVER_ONE_DAY, // 历史记录删除 时间间隔超出一天
	PU_RESULT_ITGT_ERR_1TN_DELETE_STARTTIME_LATER_THAN_ENDTIME, // 历史记录删除 起始时间大于结束时间
	PU_RESULT_ITGT_ERR_1TN_DELETE_ENDTIME_LATER_THAN_CURTIME,      // 历史记录删除 结束时间大于当前时间
	...
	PU_RESULT_PROCESS_NUM_CONFLICT,				  // 28181，onvif，sdk，1400 只能同时开启两个	

	PU_RESULT_ONVIF_NOT_ENABLED = 13680,		// ONVIF not enabled, paramters can not be set. ONVIF模块错误码空间，主线和分销的错误码不要有冲突

    PU_RESULT_ITGT_NO_DISK = 13700,               // 无SD卡
	PU_RESULT_ITGT_ERR_NEED_EVAL_FIRST = 13800, // 需要先进行手动抓拍，进行评估

	//第三方app安装错误码
    PU_RESULT_EXIT_3APP_UNSUPPORT_INSTALL_SAME = 14101, // 不支持安装同款its_App
    ...
    PU_RESULT_EXIT_3APP_RUNNING_CAN_NOT_FORMAT_SD,      // 当前有APP在运行，无法格式化SD卡
    PU_RESULT_EXIT_3APP_TAR_FILE_EXTRACT_FAIL=14234,     // 安装包解压失败
    PU_RESULT_EXIT_3APP_CERT_INVALID,                   // 证书校验失败
    PU_RESULT_EXIT_3APP_SIGN_VERIFY_FAIL,               // 签名文件校验失败
    PU_RESULT_EXIT_3APP_LICENSE_FAIL=14239,             // license文件無效
    PU_RESULT_EXIT_3APP_LICENSE_TRIAL_TIME_OUT,         // license試用時間結束
    PU_RESULT_EXIT_3APP_CERT_FILE_NOT_EXIST,            // 证书文件不存在

	PU_RESULT_APPSDK_28181_CONFLICT_ERROR = 14801,		// T28181和云服务对接协议冲突，无法同时启用
	//控件错误码，50000以上
    ...
    PU_RESULT_PLAYER_RET_CAPTURE_NO_PICTURE = 510061,  // 没有解码后的图片供抓拍
    PU_ERROR_MAX ,
} PU_ERROR_CODE_E;
...
typedef enum PU_EVENT_TYPE {
    ...
    PU_EVENT_TYPE_REPORT_VISUAL_INFO_EX,		// 上报可视化信息扩展
    PU_EVENT_TYPE_MAX
} PU_EVENT_TYPE_E;
...
typedef enum PU_MEDIA_CALLBACK_TYPE {
    PU_MEDIA_CALLBACK_TYPE_RTP = 0,     // RTP包方式，不解密
    PU_MEDIA_CALLBACK_TYPE_RTP_CRYPTO,  // RTP包形式
...
typedef enum PU_ALARM_TYPE {
    ...
    PU_ALARM_TYPE_INVADE,               // 拌线检测 已废弃
    PU_ALARM_TYPE_COUNT,                // 目标计数 已废弃
    PU_ALARM_TYPE_DISTURB,              // 干扰检测 已废弃
    ...
    PU_ALARM_TYPE_VIDEO_GAINIMBALANCE_DARK,     // 亮度诊断

    PU_ALARM_TYPE_ITS_485STROBE_EXCEPTION_ALARM = 562,  // 485频闪灯告警
    PU_ALARM_TYPE_BLACK = 570,                          //车辆黑名单布控
    PU_ALARM_TYPE_WHITE,                                //车辆白名单布控
    PU_ALARM_TYPE_FOG_DETECT  = 580,  // 雾气检测告警
...
typedef enum PU_PLATFORM_TYPE {
    PU_PLATFORM_TYPE_NVS = 1,     // NVS平台 已废弃
    PU_PLATFORM_TYPE_IVS = 2,     // IVS平台 已废弃
    PU_PLATFORM_TYPE_GBT,         // 28281平台 已废弃
...
// SDK主动注册模式
typedef enum PU_SDK_ACTIVE_REGISTER_MODE {
    PU_SDK_REGISTER_ACTIVE_MODE_SDK_1 = 0,     // 第一平台, 跟第二张网卡配合，支持到6路同时注册
    PU_SDK_REGISTER_ACTIVE_MODE_SDK_2,         // 第二平台
    PU_SDK_REGISTER_ACTIVE_MODE_SDK_3,         // 第三平台
    PU_SDK_REGISTER_ACTIVE_MODE_MAX
} PU_SDK_ACTIVE_REGISTER_MODE_E;
...
/* 功能类型 */
typedef enum PU_FEATURE_TYPE {
    PU_FEATURE_TYPE_PRERCD = 1,             // 预录
    PU_FEATURE_TYPE_MAX    = 0xFFFFFFFF     // 查询所有
} PU_FEATURE_TYPE_E;
...
/* TLS证书上传类型 */
typedef enum PU_TLS_CERT_UPLOAD_TYPE {
    PU_PHONE_APP_CA_CERT_UPLOAD_TYPE = 0,
    PU_PHONE_APP_CLIENT_CERT_UPLOAD_TYPE,
    PU_PHONE_APP_ALL_CERT_UPLOAD_TYPE,
    PU_PHONE_APP_CERT_RESTORE_TYPE,
    PU_PHONE_APP_CRL_UPLOAD_TYPE,
    PU_PHONE_APP_CERT_UPLOAD_TYPE_MAX
} PU_TLS_CERT_UPLOAD_TYPE_E;

/* 通用TLS证书上传文件类型 */
typedef enum PU_TLS_CERT_CLASS_TYPE {
    PU_PHONE_APP_CERT_CLASS_TYPE = 0,
    PU_TLS_CERT_CLASS_MAX
} PU_TLS_CERT_CLASS_TYPE_E;
...
typedef struct META_FACE_INFO {
    ...
    INT iGender;                          // 性别, 0代表男 1 代表女 2代表未知
...
typedef struct PU_AUDIO_INFO {
    ...
    CHAR enEnableType;                   // enEnableType端口使能                                    
    CHAR szReservedPlus[PU_RESERVE_LEN - 4]; // szReservedPlus[0]回音消除 AECEnable 0不使能，1使能
...
typedef struct PU_OSD_INFO {
    ...
    PU_COLOR_TYPE_E enBackgroundColor;  // 背景颜色 弃用
	...
	ULONG ulBgColor;	//背景颜色， 0-0XFFFFFF, 低位起各字节分别表示B,G,R颜色分量
    CHAR szReserveSub[PU_RESERVE_LEN - 2 - sizeof(ULONG) - sizeof(PU_OSD_POSITION_E) - sizeof(ULONG)];
...
typedef struct PU_ALARM_TIME {
    ...
    PU_TIME_S stStart;  // 起始时间，从0开始，年月日无效
    PU_TIME_S stEnd;    // 结束时间，截止24:00:00，年月日无效
...
typedef struct PU_PLATFORM_GBT_PARA_V2 {
    ...
    CHAR szPlatformId[PU_PLATFORM_INFO_LEN];     // 服务器编码
    CHAR szPassword[PU_PLATFORM_INFO_LEN];
    CHAR szServerIp[PU_IP4_ADDR_LEN];           // 平台IP
    ULONG ulServerPort;                         // 端口号
    CHAR szReserve[PU_RESERVE_LEN];  // szReserve[0]:网卡索引;
    // szReserve[1]:平台类型,入参,0:GB28181-1, 1:GB28181-2;
...
// 28281平台参数地址2次扩充
typedef struct PU_PLATFORM_GBT_PARA_V3 {
    BOOL bEnable;                                 // 使能
    CHAR szLoginDomain[LOGIN_DOMAIN_LEN_MAX];     // 服务器域
    CHAR szLoginName[PU_PLATFORM_INFO_EX_LEN];    // 登录名
    CHAR szDeviceId[PU_PLATFORM_DEVICE_ID_LEN64];   // 设备ID
    CHAR szPlatformId[PU_PLATFORM_INFO_EX_LEN];      // 服务器编码
    CHAR szPassword[PU_PASSWORD_LEN];
    CHAR szServerIp[PU_IP6_ADDR_LEN];             // 平台IP
    ULONG ulServerPort;                           // 端口号
    UCHAR ucMeshIndex;                            // 网卡索引，双网口设备备用;默认 0 eth0
    UCHAR ucServerType;                           // 平台类型,入参,0:GB28181-1, 1:GB28181-2;  请求必填
                                              
    BOOL bEnableH265;                               // 国标内部是否校验H265码流
    BOOL bPortRange;                      //是否使用范围端口
    USHORT usServerMinPort;                  //范围端口最小值
    USHORT usServerMaxPort;                  //范围端口最大值

    ULONG ulExpiration;                 //28181注册过期时间(s)
    ULONG ulHeartBeatInterval;          //28181心跳间隔(s)
    ULONG ulHeartBeatCount;             //28181心跳超时次数

    PU_STREAM_TYPE_E enStreamType;               // 码流类型,主码流、子码流1、子码流2
    PU_MEDIA_TYPE_E  enMediaType;               // 复合流、视频流; 默认以SDP信令协商为结果，若web开启，则以web为准

    CHAR         szChannelId[PU_PLATFORM_DEVICE_ID_LEN64];                              // 镜头ID
    UCHAR        ucMultiChannelNum;                                                     //通道数量
    CHAR         szMultiChannelId[PU_MULTI_CHANNEL_ID_NUM][PU_PLATFORM_DEVICE_ID_LEN64];  //多通道
    // 0:GB28181-1 , 1:GB28181-2 公用，仅在GB28181-1配置时生效  start  
    UCHAR        ucAlarmInIdNum;                                                        // 告警输入ID数量
    CHAR         szAlarmInId[PU_ALARM_DIO_NUM_MAX][PU_PLATFORM_DEVICE_ID_LEN64];        // 告警输入ID
    UCHAR        ucAlarmOutIdNum;                                                       // 告警输出ID
    CHAR         szAlarmOutId[PU_ALARM_DIO_NUM_MAX][PU_PLATFORM_DEVICE_ID_LEN64];
    UCHAR        ucAudioOutIdNum;                                                       // 音频输出ID
    CHAR         szAudioOutId[PU_AUDIO_DIO_NUM_MAX][PU_PLATFORM_DEVICE_ID_LEN64];
    BOOL    bGB35114Enable;             // GB35114 (注：带存储功能的国密TF卡插入设备后，不能用作存储卡)
    BOOL    bGB35114PastEnable;         //
    ULONG   ulGB35114EffectiveTime;    // 国标35114信令有效时间
    BOOL    bSignCheckEnable;          // 启用信令签名  end

    USHORT        usLocalPort;          // 本地端口
    CHAR szReserve[PU_RESERVE_EX_LEN];  
} PU_PLATFORM_GBT_PARA_V3_S, *LPPU_PLATFORM_GBT_PARA_V3_S;
...
typedef struct PU_PLATFORM_SDK_PARA {
    ...
    ULONG ulMeshIndex;                              // 入参，网卡索引, 多网卡设备必填，(双网卡6路)
    BOOL  bCfgManager;                              // 入参：TRUE，则下面"注册索引"字段生效，作为配置维护者
    PU_SDK_ACTIVE_REGISTER_MODE_E enRegSvrType;     // 入参: 注册索引, 同时最大支持3路
    CHAR szReserve[PU_RESERVE_LEN - sizeof(PU_CONNECT_TYPE_E) - sizeof(ULONG) - sizeof(BOOL) - sizeof(PU_SDK_ACTIVE_REGISTER_MODE_E)];
} PU_PLATFORM_SDK_PARA_S, *LPPU_PLATFORM_SDK_PARA_S;

// SDK主动注册的地址
typedef struct PU_PLATFORM_SDK_PARA_V2 {
    BOOL bEnable;
    PU_SDK_PLATFORM_MODE_E enSdkPlatformMode;
    CHAR szDeviceId[PU_PLATFORM_DEVICE_ID_LEN64];
    CHAR szPlatformIp[PU_DOMAIN_LEN];               // 支持IPV4或域名
    ULONG ulPlatformPort;
    CHAR szBackupPlatformIp[PU_DOMAIN_LEN];         // 支持IPV4或域名
    ULONG ulBackupPlatformPort;
    PU_CONNECT_TYPE_E enConnectType;
    ULONG ulMeshIndex;                              // 入参，网卡索引，多网卡设备必填，(双网卡6路)
    BOOL  bCfgManager;                              // 入参，TRUE，则下面"注册索引"字段生效，作为配置维护者
    PU_SDK_ACTIVE_REGISTER_MODE_E enRegSvrType;     // 入参，注册索引, 最大同时支持3路
    CHAR szReserve[PU_RESERVE_LEN];
} PU_PLATFORM_SDK_PARA_V2_S, *LPPU_PLATFORM_SDK_PARA_V2_S;
...
/*人脸对象使能配置*/
typedef struct PU_GAT1400_FACE_ENABLE_PARAM{
    CHAR bFaceObjEnable;
    CHAR bFaceSubImgEnable; //使能人脸图11
    CHAR bPersonSubImgEnable;//使能人员图10
}PU_GAT1400_FACE_ENABLE_PARAM_S;

/*人员对象使能配置*/
typedef struct PU_GAT1400_PERSON_ENABLE_PARAM{
    CHAR bPersonObjEnable;
}PU_GAT1400_FPERSON_ENABLE_PARAM_S;

/*非机动车对象使能配置*/
typedef struct PU_GAT1400_NONVEHICLE_ENABLE_PARAM{
    CHAR bNonVehicleObjEnable;
}PU_GAT1400_NONVEHICLE_ENABLE_PARAM_S;

/*机动车对象使能配置*/
typedef struct PU_GAT1400_VEHICLE_ENABLE_PARAM{
    CHAR bVehicleObjEnable;
    CHAR bVehicleSmallSubImgEnable;//使能车辆特写图09
}PU_GAT1400_VEHICLE_ENABLE_PARAM_S;

/*1400高级参数、平台2配置*/
typedef struct PU_GAT1400_ADVANCE_PARAM{
    CHAR   bIsGAT2;                             // 入参: 0或1，是否为GA/T 1400-2平台参数标志
    CHAR   bSuZhouEnable;                       // 出参，0或1
    PU_GAT1400_FACE_ENABLE_PARAM_S        stFaceEnablePara;
    PU_GAT1400_FPERSON_ENABLE_PARAM_S     stPersonEnablePara;
    PU_GAT1400_NONVEHICLE_ENABLE_PARAM_S  stNonVehicleEnblPara;
    PU_GAT1400_VEHICLE_ENABLE_PARAM_S     stVehicleEnablePara; 
}PU_GAT1400_ADVANCE_PARAM_S;
...
typedef struct PU_GAT1400_ENABLE_PARAM {
    ...
    // 字段扩展区，下面字段使用时，请按从上到下的字段顺序，置bit位(从低往高)
    USHORT usSetBitmap;
    PU_GAT1400_ADVANCE_PARAM_S  stAdvPlt2;          // 高级参数，和是否为平台2参数
	CHAR   szReserve[PU_RESERVE_LEN - sizeof(USHORT) - sizeof(PU_GAT1400_ADVANCE_PARAM_S)];  
...
typedef struct PU_REAL_PLAY_INFO {
    ...
    // szReserved[24]表示新警前预录，不需要填结束时间，0:不支持,1:支持
...
typedef struct PU_REAL_PLAY_INFO_V20 {
    ...
    CHAR szReserved[PU_RESERVE_LEN];               // szReserved[0]表示元数据请求类型，取值参考枚举PU_METADATA_REQUEST_TYPE_E
                                                   // szReserved[1]表示新警前预录，不需要填结束时间，0:不支持,1:支持
...
typedef struct PU_MEDIA_PLAY_INFO {
    ...
    // szReserved[21]表示新警前预录，不需要填结束时间，0:不支持,1:支持
...
/* 功能支持 */
typedef struct PU_FEATURE_ABILITY {
    ULONG             ulChannelId;          // 入参，暂不支持
    PU_FEATURE_TYPE_E enQuryType;           // 入参，必填
    ULONG             ulBitMapAbility;      // 出参
    CHAR szReserved[PU_RESERVE_LEN];
} PU_FEATURE_ABILITY_S, *LPPU_FEATURE_ABILITY_S;
...
// 可视域参数
typedef struct PU_VISUAL_FIELD_PARA {
    ULONG ulChnID;             // 通道号
    ULONG ulInstance;  		// 可视距离, 单位cm
    ULONG ulHeight;   		// 安装高度, 单位cm   
    CHAR szAzimuth[CAM_POSITION_STR_LEN];    		// 水平方位角（地磁角）
    CHAR szPitch[CAM_POSITION_STR_LEN];      		// 垂直方位角（俯仰角）
    CHAR szTiltangle[CAM_POSITION_STR_LEN];      		// 水平倾斜角（倾斜角）
    CHAR szHorFieldAngle[CAM_POSITION_STR_LEN]; 	// 水平可视角（水平视场角）
    CHAR szVerFieldAngle[CAM_POSITION_STR_LEN]; 	// 垂直可视角（垂直视场角）
    CHAR szReserved[PU_RESERVE_LEN]; 		// 预留字段
} PU_VISUAL_FIELD_PARA_S;
...
typedef struct PU_CAM_GEOG_POSITION {
    ...
    CHAR szReserved[2];         // szReserved[0]代表获取经纬度方式; szReserved[1] bit0对应nHeight, bit1对应fAzimuth, bit2对应fPitch, bit3对应dLongitude，bit4对应dLatitude
    CHAR szReserved1[PU_RESERVE_LEN -2]; //szReserved1[0-15]代表倾斜角
...
typedef struct VW_CAM_VISUAL_DISTANCE
{
    ULONG ulChnID;
    ULONG ulDistance;                         //单位厘米
}PU_CAM_VISUAL_DISTANCE_S;

typedef struct PU_PTZ_REPORT_INFO_EX {
    PU_EVENT_COMMON_S stPuEventCommon;  // 通用事件
    PU_LENS_INFO_S stCamDegree;
    PU_CAM_GEOG_POSITION_S stCamPosition;
    PU_CAM_INSTALL_HEIGHT_S stCamFixHeight;
    PU_CMOS_SIZE_PARA_S stCamCMOSSize;
    PU_CAM_VISUAL_DISTANCE_S stCamVisualDistance;
} PU_PTZ_REPORT_INFO_EX_S, *LPPU_PTZ_REPORT_INFO_EX_S;
...
typedef union PU_EVENT_NOTIFY_BODY {
    ...
    PU_PTZ_REPORT_INFO_EX_S stVisualInfoEx;             // 可视化信息上报拓展
...
/* TLS证书上传 */
typedef struct PU_TLS_CERT_UPLOAD {
    PU_TLS_CERT_UPLOAD_TYPE_E enAction;  // 上传类型
    PU_TLS_CERT_CLASS_TYPE_E  enCertType; // 证书种类
    CHAR szCaFile[PU_CONFIG_FILE_PATH_MAX];
    CHAR szCertFile[PU_CONFIG_FILE_PATH_MAX];
    CHAR szKeyFile[PU_CONFIG_FILE_PATH_MAX];
    CHAR szPassword[PU_PASSWORD_LEN];  // 私钥文件的加密Pwd
    CHAR szReserve[PU_RESERVE_EX_LEN];
} PU_TLS_CERT_UPLOAD_S, *LPPU_TLS_CERT_UPLOAD_S;
...
typedef struct MANUAL_LPR_CAPTURE_S {
    ULONG ulSnapNum;                                    // 抓拍张数
    ULONG aulSnapInterval[MAX_BURST_SHOOTING_NUM - 1];  // 抓拍间隔
    CHAR szReserved[PU_RESERVE_LEN];
...
typedef struct PU_AUTO_ARP_BROADCAST_PARA {
    BOOL bEnable;      // 启用
    ULONG ulCycleDay;  // 周期(单位:1~120分钟)
    CHAR szReserved[PU_RESERVE_LEN];
...
typedef enum PU_PIC_NAMING_TYPE {
	...
	PU_PIC_NAMING_TYPE_MOTOR_TYPE,            // 非机动车类型
    PU_PIC_NAMINT_TYPE_RIDERMAN_NUM,          // 骑行人数
...
//触发类型
typedef enum MANUAL_SNAP_TRIG_TYPE{
	PU_MANUAL_SNAP_MODE_WEB = 0,    // web触发
	PU_MANUAL_SNAP_MODE_PROTOCAL,   // sdk触发
	PU_MANUAL_SNAP_MODE_MAX
} PU_MANUAL_SNAP_TRIG_TYPE_E;
...
typedef struct PU_ITS_MANUAL_SNAPSHOT_PARA {
	...
	//拓展字段
	PU_MANUAL_SNAP_TRIG_TYPE_E snapMode;                // 触发类型
	ULONG ulVehicleNo;									// 车辆编号
	ULONG ulLaneNo;										// 车道号
	BOOL bIsCombine;                                    // 是否合成，预留
	CHAR szReserved[PU_RESERVE_LEN - 2*sizeof(ULONG) - sizeof(PU_MANUAL_SNAP_TRIG_TYPE_E) - sizeof(BOOL)];
...
typedef struct PU_PIC_FEATURE_EXTRACT {
    ...
    CHAR* szJsonFmtContentBuff;                   // json格式的内容，例如{"taskId":2000,"timeOut": 10,"facePic": "base64 pic"}
                                                  // taskId：调用方app自己维护，元数据上报时备核对
                                                  // timeOut：时间单位为秒，需大于0
                                                  // facePic：需要使用base64编码的图片，图片大小小于1M
    UINT  unContentLengh;                         // 内容长度
    UINT  uTimeout;                         	  // 接口等待，超时时间, 单位s, 若设置为0使用默认值60s
    CHAR szReserve[PU_RESERVE_EX_LEN - sizeof(UINT)];
...
// 卡口违章抓拍附加参数
typedef struct tagITSRegulationCfgAttchPassSnap
{
	BOOL pedEnable;
	BOOL nmvEnable;  
	BOOL pedAttrEnable;
	BOOL nmvAttrEnable; 
	CHAR szReserve[PU_RESERVE_LEN - 4 * sizeof(BOOL)];
} PU_ITS_REGULATION_CFG_ATTCH_PASS_SNAP_UNIT_S;
...
typedef union tagITSRegulationCfgAttch {
	...
	PU_ITS_REGULATION_CFG_ATTCH_PASS_SNAP_UNIT_S stVhdEnable;						// 卡口使能开关
...
// 智能算法类型
typedef enum PU_LIC_ITGT_FUN_TYPE {
    PU_ITGT_VHD_PARAM = 0,  	// 机非人参数
    PU_1TN_FACE_LICENSE_PARAM,        //一拖N license参数
    PU_1TN_VHD_LICENSE_PARAM,      	 // 
    PU_1TN_VHDFACE_LICENSE_PARAM, // 
    PU_VLPR_ILLEGAL_PARKING_PARA,  //违法停车
    PU_VLPR_ON_VEHICLE_LANE_PARA = 5,      		//非占机
    PU_VLPR_ON_NONEVEHICLE_LANE_PARA,	//机占非
    PU_VLPR_PRESSING_LINE_PARA,			//压线
    PU_VLPR_ABNORMAL_PLATE_PARA,			//异常车牌 —— 包括遮挡车牌，脏污车牌等（当前只有遮挡车牌）
    PU_VLPR_WRONG_DIRECTION_PARA,		//倒车、逆行
    PU_VLPR_TRAFFIC_STATISTICS = 10,				// 交通统计参数
    PU_ITGT_QUEUE_DETECTION_PARA,			// 排队长度参数
    PU_ITGT_CROWD_DENSITY_DETECTION_PARA,	// 人群密度参数
    PU_VLPR_PARA					// 车牌识别参数
} PU_LIC_ITGT_FUN_TYPE_E;

// license里每种智能算法的状态
typedef enum PU_LIC_ITGT_FUN_STATUS {
    PU_LIC_FUN_DEFAULT_STATE = 0,  // 控制项处于默认状态
    PU_LIC_FUN_TRIAL_STATE,        // 控制项处于宽限期状态
    PU_LIC_FUN_NORMAL_STATE,       // 控制项处于正常状态
    PU_LIC_FUN_EMERGENCY,          // 控制项处于紧急状态
    PU_LIC_FUN_STATE_ERROR_TAB,    // 不使用
    PU_LIC_FUN_STATE_NA            // 不涉及
} PU_LIC_ITGT_FUN_STATUS_E;

//算法license状态
typedef struct PU_ITGT_LICENSE_STATUS{
	ULONG ulChannelId;            //摄像机通道号
	PU_LIC_ITGT_FUN_TYPE_E enAlthmType;	//算法类型
	PU_LIC_ITGT_FUN_STATUS_E enAlthmStatus;    //算法License状态
}PU_ITGT_LICENSE_STATUS_S;
...
// 设备休眠状态
typedef struct PU_HIBERNATION_PARA {
    BOOL bEnable;                                     // 设备使能状态，1-休眠  0-不休眠
} PU_HIBERNATION_PARA_S;

/********** BEGIN: 从设备管理 **********/
// 从设备参数
typedef struct PU_SLAVE_DEVICE_INFO_EX {
    ULONG ulSlaveID;                        // 从设备ID
    BOOL bValid;                               // 是否有效标志位
    BOOL bStatus;					// 设备状态
    INT iSlavePort;					// 从设备端口
    CHAR szIPAddress[PU_IP4_ADDR_LEN];         // 从设备IP地址
    CHAR szSlaveName[PU_SLAVE_CLIENT_NAME_LEN];  // 从设备名称,不超过32字节字符
    CHAR szSlaveSN[PU_SLAVE_CLIENT_SN_LEN];	// 从设备SN 
    CHAR szReserved[PU_RESERVE_LEN];			// 预留
} PU_SLAVE_DEVICE_INFO_EX_S;

// 从设备列表
typedef struct PU_SLAVE_DEVICE_LIST_EX {
    PU_SLAVE_DEVICE_INFO_EX_S astSlaveInfo[PU_SLAVE_NUM_MAX];  // 从设备列表
    ULONG ulSupportNum;                                     // 从设备能力，支持的最大从设备数
    CHAR szReserved[PU_RESERVE_LEN];			// 预留
} PU_SLAVE_DEVICE_LIST_EX_S;
...
typedef struct PU_CONFIG_JSON_INPUT {
    ...
    ULONG ulRecvTimeOut;                 // 接收超时时间，单位: s，填0则使用默认超时10s
...
// 对接中维使能
typedef struct PU_JV_APPSDK_ENABLE{
	ULONG ulChannelId;                // 通道号
	BOOL enable;                // 开关使能
	PU_OPR_METHOD_E enMethod;         // 操作方法
	CHAR szReserved[PU_RESERVE_LEN];  // 保留
} PU_JV_APPSDK_ENABLE_S, *LPPU_JV_APPSDK_ENABLE_S;
...
// set  for SEC
_HW_PU_API BOOL __stdcall IVS_PU_SetSecEnable(BOOL bEnable);
...
// get sdk log fileName, szFileName存储长度不小于512
_HW_PU_API BOOL __stdcall IVS_PU_GetLogFileName(CHAR *szFileName, ULONG ulFileNameLen);
...
// 手机app证书上传兼通用证书流程
_HW_PU_API BOOL __stdcall IVS_PU_SetTlsCert(ULONG ulIdentifyID, PU_TLS_CERT_UPLOAD_S stTlsCert);
...
// 可视区域参数
_HW_PU_API BOOL __stdcall IVS_PU_SetVisualFieldPara (ULONG ulIdentifyID, PU_VISUAL_FIELD_PARA_S *pstPara);
_HW_PU_API BOOL __stdcall IVS_PU_GetVisualFieldPara (ULONG ulIdentifyID, PU_VISUAL_FIELD_PARA_S *pstPara);

// 系统休眠参数
_HW_PU_API BOOL __stdcall IVS_PU_GetHibernationPara (ULONG ulIdentifyID, PU_HIBERNATION_PARA_S *pstPara);
_HW_PU_API BOOL __stdcall IVS_PU_SetHibernationPara (ULONG ulIdentifyID, PU_HIBERNATION_PARA_S *pstPara);

// 获取从设备列表
_HW_PU_API BOOL __stdcall IVS_PU_GetSlaveDeviceList (ULONG ulIdentifyID, PU_SLAVE_DEVICE_LIST_EX_S *pstParaList);
...
_HW_PU_API BOOL __stdcall IVS_PU_SetGBTPlatformPara_V2(ULONG ulIdentifyID,
                                                       LPPU_PLATFORM_GBT_PARA_V2_S pstGbtPlatformPara);
_HW_PU_API BOOL __stdcall IVS_PU_GetGBTPlatformPara_V3(ULONG ulIdentifyID, LPPU_PLATFORM_GBT_PARA_V3_S pstGbtPlatformPara);
_HW_PU_API BOOL __stdcall IVS_PU_SetGBTPlatformPara_V3(ULONG ulIdentifyID, LPPU_PLATFORM_GBT_PARA_V3_S pstGbtPlatformPara);
...
_HW_PU_API BOOL __stdcall IVS_PU_GetSDKPlatformParaV2(ULONG ulIdentifyID, LPPU_PLATFORM_SDK_PARA_V2_S pstSdkPlatformPara);
_HW_PU_API BOOL __stdcall IVS_PU_SetSDKPlatformParaV2(ULONG ulIdentifyID, LPPU_PLATFORM_SDK_PARA_V2_S pstSdkPlatformPara);
// 设置/获取 GA/T 1400
...
// get featrue ability params
_HW_PU_API BOOL __stdcall IVS_PU_GetFeatureAbility(ULONG ulIdentifyID, LPPU_FEATURE_ABILITY_S pstFtrAbility);
...
// 获取算法license状态
_HW_PU_API BOOL __stdcall IVS_PU_GetItgtLicenseStatus (ULONG ulIdentifyID, PU_ITGT_LICENSE_STATUS_S *pstPara);
...
// 对接中维使能开关 
_HW_PU_API BOOL __stdcall IVS_PU_OprJvAppSdkSwitch(ULONG ulIdentifyID, LPPU_JV_APPSDK_ENABLE_S pstPara);
...
// 设置元数据展示类型扩展，在PlayType基础上，只要人脸识别，或只要车辆检测，或只要机非人检测，不要其他智能框
_HW_PU_API BOOL __stdcall IVS_Player_EnableShowIAPlayTypeInfo(ULONG ulIdentifyID, ULONG ulRealHandle, ULONG ulPlayType, BOOL bEnable);
// 删除自动标定点
...
// 第三方app显示框处理， pAppName传NULL，表示全算法呈现
_HW_PU_API BOOL __stdcall IVS_Player_AddAppName(ULONG ulIdentifyID, ULONG ulRealHandle, CHAR* szAppName);
